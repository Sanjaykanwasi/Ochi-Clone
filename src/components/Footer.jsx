...
const Footer = () => {
  return (
    <div className="w-full h-screen bg-zinc-900 py-20 px-20 flex gap-4 font-['Founders Grotesk X-Cond']">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-9xl tracking-tighter leading-none uppercase font-bold">
            EYE-
          </h1>
          <h1 className="text-9xl tracking-tighter leading-none uppercase font-bold">
            OPENING
      ...
      <div className="w-1/2">
        ...
        <div className="detials font-['Neue Montreal'] mt-20">
          <a className="block text-2xl font-light" href="#">
            Sanjay Singh Kanwasi
          </a>
          <a className="block text-2xl font-light mt-4" href="#">
            Sydney Sweeney
          </a>
          <a className="block mt-4 text-2xl font-light" href="#">
            Daisy Edgar Jhones
          </a>
          <a className="block mt-4 text-2xl font-light" href="#">
            Nicolle Wallace
        ...
        <div className="detials font-['Neue Montreal'] mt-72">
          <a className="block text-2xl font-light" href="#">
            Sanjay Singh Kanwasi
          </a>
          <a className="block text-2xl font-light mt-4" href="#">
